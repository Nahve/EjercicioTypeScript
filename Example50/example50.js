...
function pedirNumero(pregunta) {
    return new Promise(function (resolve, reject) {
        rl.question(pregunta, function (respuesta) {
            var numero = parseInt(respuesta, 10);
            if (isNaN(numero)) {
...
function compararNumeros() {
    return __awaiter(this, void 0, void 0, function () {
        var num1, num2, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, 4, 5]);
                    return [4 /*yield*/, pedirNumero("Introduce el primer número entero: ")];
                case 1:
                    num1 = _a.sent();
                    return [4 /*yield*/, pedirNumero("Introduce el segundo número entero: ")];
                case 2:
                    num2 = _a.sent();
                    if (num1 === num2) {
                        ...
                        console.log("El n\u00FAmero mayor es: ".concat(num1));
                    }
                    else {
                        console.log("El n\u00FAmero mayor es: ".concat(num2));
                    }
                    return [3 /*break*/, 5];
                case 3:
                    error_1 = _a.sent();
